...
extern "C" {
         ...
         */
        I2C_BUS(I2C1)
        I2C_SLAVE_DEVICE(I2C1, TEMP, 0x30, HW_I2C_ADDRESSING_7B, HW_I2C_SPEED_FAST);
        I2C_SLAVE_DEVICE(I2C1, ACCEL, 0x1D, HW_I2C_ADDRESSING_7B, HW_I2C_SPEED_FAST);
        I2C_SLAVE_DEVICE(I2C1, MAG, 0x1E, HW_I2C_ADDRESSING_7B, HW_I2C_SPEED_FAST);
        I2C_BUS_END
        ...
        GPADC_SOURCE(TEMP_SENSOR, HW_GPADC_CLOCK_INTERNAL, HW_GPADC_INPUT_MODE_SINGLE_ENDED,
                        HW_GPADC_INPUT_SE_P12, 15, true, HW_GPADC_OVERSAMPLING_128_SAMPLES,
                        HW_GPADC_INPUT_VOLTAGE_UP_TO_3V6)
        ...
        GPADC_SOURCE(ANALOG_GROUND, HW_GPADC_CLOCK_DIGITAL, HW_GPADC_INPUT_MODE_SINGLE_ENDED,
                        HW_GPADC_INPUT_SE_AVS, 5, true, HW_GPADC_OVERSAMPLING_4_SAMPLES,
                        HW_GPADC_INPUT_VOLTAGE_UP_TO_1V2)
